...
export default function SmartNotifications({ onAction }: SmartNotificationsProps) {
  ...
  useEffect(() => {
    ...
    const initial: SmartNotification[] = [
      {
        id: "n1",
        type: "challenge",
        title: "چالش تمرکز ۵ دقیقه‌ای",
        message: "آیا آماده‌ای تله تستی 'قیدهای زیست‌شناسی' را همین الان در ۵ دقیقه مرور کنی؟",
      ...
      },
      {
        id: "n2",
        type: "motivation",
        title: "پیام مربی کایزن",
        message: "یادت باشه رتبه برتر شدن نتیجه تکرار کارهای کوچک درسته. امروز عالی بودی!",
    ...
    // Random trigger for a popup (simulating an interaction app-like notification)
    const timer = setTimeout(() => {
      ...
      setShowPopup(popup);
      setNotifications(prev => [popup, ...prev]);
    }, 5000);
